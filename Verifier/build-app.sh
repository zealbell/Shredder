#!/usr/bin/env bash
#
# Build a double-clickable native app for Verifier.
#
#   ./build-app.sh          # builds Verifier.app under dist/
#   ./build-app.sh dmg      # also builds a Verifier-<version>.dmg installer
#
...
APP_NAME="Verifier"
MAIN_CLASS="com.verifier.Launcher"
VERSION="1.0.0"
MVN="${MVN:-mvn}"
DIST_DIR="dist"
