...
> **Report Generated:** February 15, 2026 21:49:41  
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1.26.0</td>
      <td>Yes</td>
      <td>{ [header(10B)][input(8391168B)][trailer(8B)] }</td>
...
|---|---|---|---|---|---|---|---|---|---|
| Light | 1.000 | 0.0% | 414.7 MB/s | 474.0 MB/s | 8.00 | 1.00× | 9 MB | 117% | ✅ |
| GZIP | 0.851 | 14.9% | 14.7 MB/s | 87.1 MB/s | 6.81 | 1.18× | 9 MB | 103% | ✅ |
| Zstandard | 0.604 | 39.6% | 81.6 MB/s | 156.0 MB/s | 4.83 | 1.66× | 9 MB | 110% | ✅ |
...
|---|---|---|---|---|---|---|---|---|---|
| **average** | **1.000** | **0.0%** | **414.7 MB/s** | **474.0 MB/s** | **8.00** | **1.00×** | **9 MB** | **117%** | **✅** |
| archives | 1.000 | 0.0% | 572.2 MB/s | 752.3 MB/s | 8.00 | 1.00× | 8 MB | 104% | ✅ |
| contents | 1.000 | 0.0% | 293.3 MB/s | 328.8 MB/s | 8.00 | 1.00× | 9 MB | 119% | ✅ |
| blobs | 1.000 | 0.0% | 1,350.0 MB/s | 1,502.6 MB/s | 8.00 | 1.00× | 9 MB | 109% | ✅ |
...
| Directory | `Ratio` | `Savings` | `Cospeed` | `Despeed` | `BPB` | `Factor` | `Mutilization` | `Putilization` | `Integrity` |
|---|---|---|---|---|---|---|---|---|---|
| **average** | **0.851** | **14.9%** | **14.7 MB/s** | **87.1 MB/s** | **6.81** | **1.18×** | **9 MB** | **103%** | **✅** |
| archives | 0.963 | 3.7% | 9.0 MB/s | 152.0 MB/s | 7.70 | 1.04× | 8 MB | 62% | ✅ |
| contents | 0.901 | 9.9% | 15.0 MB/s | 72.9 MB/s | 7.21 | 1.11× | 9 MB | 107% | ✅ |
| blobs | 0.284 | 71.6% | 18.2 MB/s | 150.2 MB/s | 2.27 | 3.52× | 9 MB | 101% | ✅ |
...
| Directory | `Ratio` | `Savings` | `Cospeed` | `Despeed` | `BPB` | `Factor` | `Mutilization` | `Putilization` | `Integrity` |
|---|---|---|---|---|---|---|---|---|---|
| **average** | **0.604** | **39.6%** | **81.6 MB/s** | **156.0 MB/s** | **4.83** | **1.66×** | **9 MB** | **110%** | **✅** |
| archives | 0.968 | 3.2% | 194.4 MB/s | 278.9 MB/s | 7.74 | 1.03× | 9 MB | 79% | ✅ |
| contents | 0.600 | 40.0% | 62.2 MB/s | 127.1 MB/s | 4.80 | 1.67× | 9 MB | 114% | ✅ |
| blobs | 0.275 | 72.5% | 143.7 MB/s | 293.3 MB/s | 2.20 | 3.64× | 10 MB | 105% | ✅ |
...
| Codec | `Ratio` | `Savings` | `Cospeed` | `Despeed` | `BPB` | `Factor` | `Mutilization` | `Putilization` | `Integrity` |
|---|---|---|---|---|---|---|---|---|---|
| Light | 1.000 | 0.0% | 143.6 MB/s | 160.2 MB/s | 8.00 | 1.00× | 10 MB | 121% | ✅ |
| GZIP | 0.498 | 50.2% | 8.2 MB/s | 36.2 MB/s | 3.98 | 2.01× | 9 MB | 118% | ✅ |
| Zstandard | 0.503 | 49.7% | 33.3 MB/s | 61.2 MB/s | 4.02 | 1.99× | 10 MB | 124% | ✅ |
...
| Directory | `Ratio` | `Savings` | `Cospeed` | `Despeed` | `BPB` | `Factor` | `Mutilization` | `Putilization` | `Integrity` |
|---|---|---|---|---|---|---|---|---|---|
| **average** | **1.000** | **0.0%** | **143.6 MB/s** | **160.2 MB/s** | **8.00** | **1.00×** | **10 MB** | **121%** | **✅** |
| archives | 1.000 | 0.0% | 1,647.7 MB/s | 1,902.7 MB/s | 8.00 | 1.00× | 10 MB | 101% | ✅ |
| contents | 1.000 | 0.0% | 122.4 MB/s | 136.6 MB/s | 8.00 | 1.00× | 10 MB | 122% | ✅ |
| blobs | 1.000 | 0.0% | 1,616.1 MB/s | 1,726.4 MB/s | 8.00 | 1.00× | 10 MB | 104% | ✅ |
...
| Directory | `Ratio` | `Savings` | `Cospeed` | `Despeed` | `BPB` | `Factor` | `Mutilization` | `Putilization` | `Integrity` |
|---|---|---|---|---|---|---|---|---|---|
| **average** | **0.498** | **50.2%** | **8.2 MB/s** | **36.2 MB/s** | **3.98** | **2.01×** | **9 MB** | **118%** | **✅** |
| archives | 0.958 | 4.2% | 20.2 MB/s | 239.5 MB/s | 7.67 | 1.04× | 10 MB | 100% | ✅ |
| contents | 0.496 | 50.4% | 8.1 MB/s | 33.9 MB/s | 3.97 | 2.02× | 9 MB | 118% | ✅ |
| blobs | 0.300 | 70.0% | 20.0 MB/s | 152.3 MB/s | 2.40 | 3.33× | 10 MB | 101% | ✅ |
...
| Directory | `Ratio` | `Savings` | `Cospeed` | `Despeed` | `BPB` | `Factor` | `Mutilization` | `Putilization` | `Integrity` |
|---|---|---|---|---|---|---|---|---|---|
| **average** | **0.503** | **49.7%** | **33.3 MB/s** | **61.2 MB/s** | **4.02** | **1.99×** | **10 MB** | **124%** | **✅** |
| archives | 0.961 | 3.9% | 374.9 MB/s | 548.5 MB/s | 7.69 | 1.04× | 10 MB | 102% | ✅ |
| contents | 0.501 | 49.9% | 30.2 MB/s | 56.0 MB/s | 4.01 | 2.00× | 10 MB | 124% | ✅ |
| blobs | 0.299 | 70.1% | 120.6 MB/s | 300.7 MB/s | 2.39 | 3.34× | 10 MB | 104% | ✅ |
...
| Codec | `Ratio` | `Savings` | `Cospeed` | `Despeed` | `BPB` | `Factor` | `Mutilization` | `Putilization` | `Integrity` |
|---|---|---|---|---|---|---|---|---|---|
| Light | 1.000 | 0.0% | 1,834.0 MB/s | 1,634.5 MB/s | 8.00 | 1.00× | 9 MB | 80% | ✅ |
| GZIP | 0.563 | 43.7% | 13.6 MB/s | 215.1 MB/s | 4.51 | 1.78× | 9 MB | 86% | ✅ |
| Zstandard | 0.556 | 44.4% | 263.3 MB/s | 395.9 MB/s | 4.45 | 1.80× | 10 MB | 94% | ✅ |
...
| Directory | `Ratio` | `Savings` | `Cospeed` | `Despeed` | `BPB` | `Factor` | `Mutilization` | `Putilization` | `Integrity` |
|---|---|---|---|---|---|---|---|---|---|
| **average** | **1.000** | **0.0%** | **1,834.0 MB/s** | **1,634.5 MB/s** | **8.00** | **1.00×** | **9 MB** | **80%** | **✅** |
| archives | 1.000 | 0.0% | 2,030.1 MB/s | 1,933.8 MB/s | 8.00 | 1.00× | 10 MB | 83% | ✅ |
| contents | 1.000 | 0.0% | 1,796.0 MB/s | 1,745.2 MB/s | 8.00 | 1.00× | 9 MB | 83% | ✅ |
| blobs | 1.000 | 0.0% | 1,676.0 MB/s | 1,224.5 MB/s | 8.00 | 1.00× | 9 MB | 75% | ✅ |
...
| Directory | `Ratio` | `Savings` | `Cospeed` | `Despeed` | `BPB` | `Factor` | `Mutilization` | `Putilization` | `Integrity` |
|---|---|---|---|---|---|---|---|---|---|
| **average** | **0.563** | **43.7%** | **13.6 MB/s** | **215.1 MB/s** | **4.51** | **1.78×** | **9 MB** | **86%** | **✅** |
| archives | 1.000 | -0.0% | 16.4 MB/s | 421.7 MB/s | 8.00 | 1.00× | 10 MB | 84% | ✅ |
| contents | 0.345 | 65.5% | 10.1 MB/s | 103.4 MB/s | 2.76 | 2.90× | 9 MB | 76% | ✅ |
| blobs | 0.345 | 65.5% | 14.3 MB/s | 120.3 MB/s | 2.76 | 2.90× | 9 MB | 96% | ✅ |
...
| Directory | `Ratio` | `Savings` | `Cospeed` | `Despeed` | `BPB` | `Factor` | `Mutilization` | `Putilization` | `Integrity` |
|---|---|---|---|---|---|---|---|---|---|
| **average** | **0.556** | **44.4%** | **263.3 MB/s** | **395.9 MB/s** | **4.45** | **1.80×** | **10 MB** | **94%** | **✅** |
| archives | 1.000 | 0.0% | 649.9 MB/s | 625.1 MB/s | 8.00 | 1.00× | 10 MB | 98% | ✅ |
| contents | 0.335 | 66.5% | 66.1 MB/s | 266.7 MB/s | 2.68 | 2.99× | 9 MB | 88% | ✅ |
| blobs | 0.335 | 66.5% | 74.1 MB/s | 296.0 MB/s | 2.68 | 2.99× | 9 MB | 95% | ✅ |
...
| Codec | `Ratio` | `Savings` | `Cospeed` | `Despeed` | `BPB` | `Factor` | `Mutilization` | `Putilization` | `Integrity` |
|---|---|---|---|---|---|---|---|---|---|
| Light | 1.000 | 0.0% | 425.1 MB/s | 435.0 MB/s | 8.00 | 1.00× | 9 MB | 114% | ✅ |
| GZIP | 2.488 | -148.8% | 8.5 MB/s | 137.1 MB/s | 19.90 | 0.40× | 9 MB | 109% | ✅ |
| Zstandard | 1.667 | -66.7% | 176.6 MB/s | 154.7 MB/s | 13.33 | 0.60× | 9 MB | 116% | ✅ |
...
|---|---|---|---|---|---|---|---|---|---|
| **average** | **1.000** | **0.0%** | **425.1 MB/s** | **435.0 MB/s** | **8.00** | **1.00×** | **9 MB** | **114%** | **✅** |
| B | 1.000 | 0.0% | 0.1 MB/s | 0.1 MB/s | 8.00 | 1.00× | 9 MB | 120% | ✅ |
| KB | 1.000 | 0.0% | 130.6 MB/s | 126.9 MB/s | 8.00 | 1.00× | 9 MB | 121% | ✅ |
| MB | 1.000 | 0.0% | 1,453.1 MB/s | 1,496.4 MB/s | 8.00 | 1.00× | 9 MB | 94% | ✅ |
...
| Size | `Ratio` | `Savings` | `Cospeed` | `Despeed` | `BPB` | `Factor` | `Mutilization` | `Putilization` | `Integrity` |
|---|---|---|---|---|---|---|---|---|---|
| **average** | **2.488** | **-148.8%** | **8.5 MB/s** | **137.1 MB/s** | **19.90** | **0.40×** | **9 MB** | **109%** | **✅** |
| B | 5.013 | -401.3% | 0.1 MB/s | 0.1 MB/s | 40.10 | 0.20× | 9 MB | 123% | ✅ |
| KB | 1.005 | -0.5% | 11.7 MB/s | 91.2 MB/s | 8.04 | 1.00× | 9 MB | 111% | ✅ |
| MB | 1.000 | -0.0% | 15.7 MB/s | 398.4 MB/s | 8.00 | 1.00× | 9 MB | 85% | ✅ |
...
| Size | `Ratio` | `Savings` | `Cospeed` | `Despeed` | `BPB` | `Factor` | `Mutilization` | `Putilization` | `Integrity` |
|---|---|---|---|---|---|---|---|---|---|
| **average** | **1.667** | **-66.7%** | **176.6 MB/s** | **154.7 MB/s** | **13.33** | **0.60×** | **9 MB** | **116%** | **✅** |
| B | 2.798 | -179.8% | 0.1 MB/s | 0.1 MB/s | 22.39 | 0.36× | 9 MB | 124% | ✅ |
| KB | 1.002 | -0.2% | 99.5 MB/s | 85.6 MB/s | 8.01 | 1.00× | 9 MB | 124% | ✅ |
| MB | 1.000 | -0.0% | 539.0 MB/s | 474.0 MB/s | 8.00 | 1.00× | 9 MB | 94% | ✅ |
